...
MOCK_MODULES = ['Bio', 'Bio.Entrez', 'Bio.KEGG', 'Bio.KEGG.REST', '_pickle', 'collections', 'collections.defaultdict', 'gensim.parsing.preprocessing', 'gensim.parsing.preprocessing.preprocess_string', 'gensim.parsing.preprocessing.strip_multiple_whitespaces', 'gensim.parsing.preprocessing.strip_punctuation', 'gensim.parsing.preprocessing.strip_tags', 'gensim.utils', 'gensim.utils.simple_preprocess', 'glob', 'glob.glob', 'itertools.chain', 'itertools.product', 'networkx', 'nltk', 'nltk.corpus', 'nltk.corpus.wordnet', 'nltk.probability', 'nltk.probability.FreqDist', 'nltk.sent_tokenize', 'nltk.tokenize', 'nltk.tokenize.sent_tokenize', 'nltk.tokenize.word_tokenize', 'numpy', 'pandas', 'pronto', 'pytorch_pretrained_bert', 'pytorch_pretrained_bert.BertForMaskedLM', 'pytorch_pretrained_bert.BertModel', 'pytorch_pretrained_bert.BertTokenizer', 'pywsd.lesk', 'pywsd.lesk.cosine_lesk', 'random', 'rapidfuzz', 'rapidfuzz.fuzz', 'rapidfuzz.process', 'scipy.spatial.distance', 'scipy.spatial.distance.cdist', 'scipy.spatial.distance.pdist', 'scipy.spatial.distance.squareform', 'scipy.stats', 'scipy.stats.fisher_exact', 'sklearn.decomposition', 'sklearn.decomposition.LatentDirichletAllocation', 'sklearn.decomposition.NMF', 'sklearn.feature_extraction.text', 'sklearn.feature_extraction.text.CountVectorizer', 'sklearn.feature_extraction.text.TfidfVectorizer', 'sklearn.neighbors', 'sklearn.neighbors.NearestNeighbors', 'torch']

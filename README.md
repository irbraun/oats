...
This class contains several methods for adding to, filtering, or accessing the dataset in different ways. This includes getting dictionaries that map the unique internal identifiers to text descriptions or annotations. This class also extends the functionality of a regular dataframe by handling the process of merging information pertaining to the same gene that is added from multiple sources. See the full documentation for details.
